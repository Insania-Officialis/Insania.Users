...
/// <summary>
/// Тесты сервиса работы с данными игроков
/// </summary>
[TestFixture]
public class PlayersDAOTests : BaseTest
{
    #region Поля
    /// <summary>
    ...
    /// <summary>
    /// Тест метода получения списка игроков
    /// </summary>
    [Test]
    public async Task GetListTest()
    {
        try
        {
            ...
            List<Player>? result = await PlayersDAO.GetList();
